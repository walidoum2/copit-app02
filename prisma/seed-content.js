...
const FAQS = [
  ...
  { order: 3, questionFr: "Combien coûte la livraison et vers quelles wilayas ?", questionAr: "شحال يكلف التوصيل ولأي ولايات؟", questionEn: "How much is delivery and which wilayas?", answerFr: "On livre dans les 58 wilayas. Le prix exact s'affiche automatiquement selon ta wilaya au moment de la commande.", answerAr: "نوصلو لـ 58 ولاية. الثمن الدقيق يبان مباشرة حسب ولايتك.", answerEn: "We deliver to all 58 wilayas. The exact price shows automatically based on your wilaya at checkout." },
...
const WHYUS = [
  ...
  { order: 3, icon: "map", headingFr: "58 wilayas couvertes", headingAr: "58 ولاية", headingEn: "58 wilayas covered", paragraphFr: "Domicile ou stopdesk, livraison 2 à 5 jours selon ta wilaya.", paragraphAr: "للمنزل أو ستوب ديسك، التوصيل من 2 إلى 5 أيام حسب ولايتك.", paragraphEn: "Home or stopdesk, delivery in 2 to 5 days depending on your wilaya." },
